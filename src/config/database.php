    ...
    */
    ...
    'connections' => [
        ...
        'import_source_database' =>  [
            ...
            'port' => env('IMPORT_SOURCE_DB_PORT', '3306'),
            'database' => env('IMPORT_SOURCE_DB_DATABASE', 'forge'),
            'username' => env('IMPORT_SOURCE_DB_USERNAME', 'forge'),
            'password' => env('IMPORT_SOURCE_DB_PASSWORD', ''),
            'unix_socket' => env('IMPORT_SOURCE_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
