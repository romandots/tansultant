<?php
/**
 * File: ContractAlreadyTerminatedException.php
...
/**
 * Class ContractAlreadyTerminatedException
 * @package App\Service\Contract\Exceptions
 */
class ContractAlreadyTerminatedException extends ContractServiceException
{
    /**
