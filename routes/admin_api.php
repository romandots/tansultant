...
Route::namedGroup('transactions',ManagerApi\TransactionController::class, static function () {
    ...
    Route::namedRoute('qr', 'get', '{id:uuid}/qr', [TransactionsPermission::MANAGE, TransactionsPermission::CREATE]);
    Route::namedRoute('sendPaymentLink', 'post', '{id:uuid}/send', [TransactionsPermission::MANAGE, TransactionsPermission::CREATE]);
